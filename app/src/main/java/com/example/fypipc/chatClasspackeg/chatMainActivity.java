...
public class chatMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            makeText(this, "Welcome"+FirebaseAuth.getInstance().getCurrentUser().getDisplayName(), Toast.LENGTH_SHORT).show();
            ShowChatroom();
        }
    ...
    public void ShowChatroom()
    {
        ...
        adapter = new MessageClass(this, chatClass.class, R.layout.message_in, FirebaseDatabase.getInstance().getReference());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item)
    {
        if(item.getItemId()==R.id.menu_sign_out)
            AuthUI.getInstance().signOut(this).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                {
                    makeText(chatMainActivity.this, "You have Sign out", Toast.LENGTH_SHORT).show();
                    finish();
