...
import com.example.fypipc.Dahsboard.dashboard;
...
public class loginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_buttons = (Button) findViewById(R.id.dashboard);
                    ...
                    mAuth.signInWithEmailAndPassword(emailID, passID).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Intent gameIntent = new Intent(getApplicationContext(), dashboard.class);
